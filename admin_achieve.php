...
<head>
  ...
  <link rel="stylesheet" href="admin_achieve.css" />
...
<div class="main-content">
  ...
  <div class="main-content">
    <h2>Achievements</h2>
    <div class="grid" id="achievementsGrid"></div>

    <div class="form-section">
      <h3>Add New Achievement</h3>
      <input type="text" id="newTitle" placeholder="Title" required>
      <input type="file" id="newImage" accept="image/*" required>
      <textarea id="newDescription" rows="3" placeholder="Description" required></textarea>
...
<script src="admin_achieve.js"></script>
</body>
</html>     