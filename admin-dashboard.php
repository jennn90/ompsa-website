...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (!empty($newName)) {
        ...
        if ($stmt->execute()) {
            $_SESSION['admin_name'] = $newName; // Update session
    ...
    // Reload page to reflect updated session values
...
<div class="main-content">
  <header>
    ...
    <div class="profile" id="profileBtn">
      ...
      <span><?= htmlspecialchars($_SESSION['admin_name'] ?? $_SESSION['admin_email'] ?? '') ?></span> <!-- Show name -->
    </div>
  ...
  <div class="content">
    <div class="search-bar">
      <img src="images/searchicon.png" class="search-icon" alt="Search">
    ...
    <div class="top-icons"> 
      <div class="icon-wrapper">
          <div class="icon-box">
            <a href="admin_history.php"><img src="images/history logo.png" width="40" height="40"></a>
          </div>
          <div class="label">History</div>
        </div>
        <div class="icon-wrapper">
          <div class="icon-box">
            <a href="adminfaculty.php"><img src="images/Faculty logo.png" width="40" height="40"></a>
          </div>
          <div class="label">Faculty</div>
        </div>
        <div class="icon-wrapper">
          <div class="icon-box">
            <a href="admin_annouce.php"><img src="images/announcement logo.png" width="40" height="40"></a>
          </div>
          <div class="label">Announcements</div>
        </div>
        <div class="icon-wrapper">
          <div class="icon-box">
            <a href="admin_achieve.php"><img src="images/achievement logo.png" width="40" height="40"></a>
          </div>
          <div class="label">Achievements</div>
        </div>
        <div class="icon-wrapper">
          <div class="icon-box">
            <a href="Academic Offerings.html"><img src="images/acadofferings logo.png" width="40" height="40"></a>
          </div>
    ...
    <div class="mission-vision">
      <div class="mv-box">
        <h2>MISSION</h2>
        <p>The Diocesan Catholic Schools of Marinduque are committed to develop Christ-centered individuals through Relevant and Quality Catholic Education and involvement in the Life and Mission of the Church.</p>
      </div>
      <div class="mv-box">
        <h2>VISION</h2>
        <p>The Diocesan Catholic Schools of Marinduque envision an Evangelized Community promoting Justice, Charity and Peace in the constant pursuit for Excellence.</p>
      </div>
    </div>
  </div>
</div>
